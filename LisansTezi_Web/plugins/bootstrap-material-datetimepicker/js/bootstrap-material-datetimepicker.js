(function ($, moment)
{
   ...
   function Plugin(element, options)
   {
      ...
      this.params = { date: true, time: true, format: 'DD-MM-YYYY', minDate: null, maxDate: null, currentDate: null, lang: 'tr', weekStart: 0, shortTime: false, clearButton: false, nowButton: true, cancelText: 'Iptal', okText: 'TAMAM', clearText: 'Temizle', nowText: 'BUGUN', switchOnClick: false };
